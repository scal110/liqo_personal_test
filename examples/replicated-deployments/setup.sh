...
LIQO_CLUSTER_CONFIG_YAML2="$here/manifests/cluster2.yaml"
LIQO_CLUSTER_CONFIG_YAML3="$here/manifests/cluster3.yaml"
...
create_cluster "$CLUSTER_NAME_DESTINATION1" "$KUBECONFIG_DESTINATION1" "$LIQO_CLUSTER_CONFIG_YAML2"
create_cluster "$CLUSTER_NAME_DESTINATION2" "$KUBECONFIG_DESTINATION2" "$LIQO_CLUSTER_CONFIG_YAML3"
